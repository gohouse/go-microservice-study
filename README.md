# go-microservice-study 
golang一步步深入微服务
---
## 目录
- [v1. golang使用protobuf学习笔记](#v1-golang使用protobuf学习笔记)
- [v2. golang使用grpc和protobuf学习笔记](#v2-golang使用grpc和protobuf学习笔记)
- [v3. go-micro初探学习笔记](#v3-go-micro初探学习笔记)
